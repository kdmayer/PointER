...
Then run
    ...
    zip CS224W_LIDAR/assets/local_authority_boundaries/E06000014_boundary_shp.zip \
...
are inserted into the database. So the program should also work, if this existing files are not deleted. 
